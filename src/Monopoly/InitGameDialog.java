...
public class InitGameDialog extends javax.swing.JDialog 
{
    ...
    private class GoButtonListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "Sie müssen ein Betrag eingeben für das Los");
            }
        }
    }
    /**
    ...
    public InitGameDialog(java.awt.Frame parent, boolean modal)
    {
        ...
        pieces.add(new Piece("Kanone"));
        pieces.add(new Piece("Hund"));
        pieces.add(new Piece("Kampfschiff"));
        pieces.add(new Piece("Auto"));
        pieces.add(new Piece("Buegeleisen"));
        pieces.add(new Piece("Hut"));
        pieces.add(new Piece("Fingerhut"));
        pieces.add(new Piece("Schubkarre"));
        pieces.add(new Piece("Schuh"));
        pieces.add(new Piece("Portmonai"));
        lockInsPressed = 0;
    ...
    private void nahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nahButtonActionPerformed
        JOptionPane.showMessageDialog(null, "Mmm doch nicht! Tschüss!");
        System.exit(0);
